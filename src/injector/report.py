    ...
    rows = [
        {
            ...
            "judge_rationale": redact(f.sample_response, f.severity, redact_enabled),
            "raw_response_excerpt": redact(f.raw_responses[0], f.severity, redact_enabled) if f.raw_responses else "",
            "raw_response_count": len(f.raw_responses),
